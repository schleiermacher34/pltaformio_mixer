...
void ui_Screen1_screen_init(void)
{
    ...
    lv_obj_set_x(ui_Screen1_Arc1, 291);
    lv_obj_set_y(ui_Screen1_Arc1, 124);
    ...
    lv_obj_set_style_text_font(ui_Screen1_Label10, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
